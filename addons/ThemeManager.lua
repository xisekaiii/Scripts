...
local ThemeManager = {} do
	ThemeManager.Folder = 'Shadow Hub Scripts'

	ThemeManager.Library = nil
	ThemeManager.BuiltInThemes = {
		['Catalyst Hub']        = { 1, httpService:JSONDecode('{"FontColor":"ffffff","MainColor":"000b16","AccentColor":"3c85e0","BackgroundColor":"08080d","OutlineColor":"011b2b"}') },
